...
wao_function_levi = np.load("leviWAO.npy")
...
wao_watts_strogatz_graph_function_levi = np.load("leviNetwork.npy")
...
plt.plot(wao_function_levi,'r-',label="Levi WOA")
plt.plot(wao_watts_strogatz_graph_function_levi,'r--',label="Levi small-world graph")
