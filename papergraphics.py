...
plt.xlabel("Iteration")
plt.ylabel("Fitness")
plt.plot(wao_function_bukin,'g-',label="Bukin WOA")
plt.plot(wao_watts_strogatz_graph_function_bukin,'g--',label="Bukin small-world network")
plt.plot(wao_function_schaffer,'b-',label="Schaffer WOA",)
plt.plot(wao_watts_strogatz_graph_function_schaffer,'b--',label="Schaffer small-world network")
plt.plot(wao_function_hump,'r-',label="Hump WOA")
plt.plot(wao_watts_strogatz_graph_function_hump,'r--',label="Hump small-world network")
plt.plot(wao_function_matyas,'c-',label="Matyas WOA",)
plt.plot(wao_watts_strogatz_graph_function_matyas,'c--',label="Matyas small-world network")
plt.yscale("log")
plt.legend()
plt.tight_layout()
